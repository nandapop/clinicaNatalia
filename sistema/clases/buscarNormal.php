	...
	<input class="inputNormal" disabled="disabled" class="inputNormal" type="text" id="edad" size="4" value ="<?php if($pacientes[0]->FechaNac!="0000-00-00 00:00:00") echo calcularEdad($pacientes[0]->FechaNac); ?>" /></td>
		...
		<tr>
			<td class="label" onmouseover="muestraAyuda(event, 'PrimeraConsulta','')">Primera Cita</td>
				<?php
					if($pacientes[0]->FechaPrimeraCita!="0000-00-00 00:00:00")
					{
						list($anoP, $mesP, $resto) = split("-",$pacientes[0]->FechaPrimeraCita);
				...
				?>
			<td class="campo"><input class="inputNormal" type="text" id="diaPrimeraCita" name="diaPrimeraCita" size="1" maxlength="2"/ value="<?php echo $diaP;?>">/<input class="inputNormal" type="text" id="mesPrimeraCita" name="mesPrimeraCita" size="1" maxlength="2"/ value="<?php echo $mesP;?>">/<input class="inputNormal" type="text" id="anoPrimeraCita" name="anoPrimeraCita" size="5" maxlength="4"/ value="<?php echo $anoP;?>"></td>
		</tr>
		<tr>
			...
			<td colspan="2">
			  <div id="menudown">
				<ul>
				  ...
				  <li><a href="javascript:location.href='buscarNormal.php'" title="Volver"><img alt="Volver" src="imagenes/volver.gif" width="25" height="25" />Volver</a></li>
