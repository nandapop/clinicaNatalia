	...
	<tr>
		<table style="border:0px" >
			<tr>
				...
				<p align="left"><textarea name='indicaciones' id="indicaciones" cols='3' rows='3' onpaste="cambiarEstadoPegando()" oninput="guardarTextoPegado(event, this);" onkeyup="inputFilling(event, this);" onblur="setInput(this, document.getElementById('lista'))"></textarea>
